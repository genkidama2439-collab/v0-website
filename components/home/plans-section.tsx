...
const tours: Tour[] = [
  ...
  {
    name: "サンセットSUP",
    tagline: "夕日を浴びながらの海上散歩",
    description: "海の上から眺める夕日のグラデーションは圧巻。初心者でも安定のボードで安心。エモーショナルなシルエット写真が大人気。通常プランと1組貸切から選べます。",
    ...
    variants: [
      ...
      },
      {
        ...
        price: "¥9,500",
        priceNote: "子供¥8,500",
        highlights: ["1組貸切・専属ガイド", "ウェットスーツ無料", "度付きマスク無料", "シルエット写真撮影"],
        included: ["SUPボード", "パドル", "ライフジャケット", "ウェットスーツ", "度付きマスク", "写真・動画データ", "保険"],
      },
    ],
  },
  {
...
const quickCompare = [
  ...
  { id: "S8", name: "サンセットSUPツアー", age: "5〜65歳", time: "約2時間", bestFor: "カップル・夕日撮影" },
