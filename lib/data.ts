...
export interface FAQ {
  ...
  // リンクは本文へ埋め込まずここで持つ。構造化データ(FAQJsonLd)は question/answer のみ使う。
...
export const FAQS: FAQ[] = [
  ...
  },
  {
    question: "集合場所はどこですか？",
    answer:
      "集合場所はプランによって異なります。宮古島は同じ日でも風向きによってビーチのコンディションが大きく変わるため、当日の海況を見て、その日いちばん穏やかで安全なビーチを選んでご案内しています。そのため集合場所の確定は前日となり、地図リンクと駐車場の場所をあわせてLINEでお送りします。ご不明な点はそのままLINEでご質問いただけます。",
  ...
  },
  {
    question: "雨の日の代替プランは？",
    answer:
      "海亀兄弟では、雨の日でも楽しめる室内の「レジンアート体験」をご用意しています。宮古島の海をイメージしたオリジナルアクセサリーを作れる体験で、小さなお子様連れの方にも人気です。空き状況やご希望はLINEでお気軽にご相談ください。そのほか、宮古島海中公園や雪塩ミュージアムなど屋内施設も充実しています。",
    link: { href: "/blog/miyakojima-rainy-day-guide", label: "雨の日の過ごし方ガイドを見る" },
  },
  {
