...
// 英語サイトに掲載するプランの訳文。貸切4プランのみ（通常プランは掲載しないため訳文も持たない）。
const EN_PLANS_ALL: EnPlanContent[] = [
  {
    id: "S2",
  ...
  },
  {
    ...
    tagline: "Glide across golden water at magic hour, with drone photos from above.",
    description: [
  ...
  {
    id: "S7",
    name: "Private Miyakojima Drone SUP Experience",
    tagline: "A private daytime SUP session on Miyako blue water with drone footage — just for your group.",
    description: [
...
// 英語サイトに掲載するプラン。貸切のみ（INTL_PLAN_IDS）に絞る。
export const EN_PLANS: EnPlanContent[] = EN_PLANS_ALL.filter((p) => INTL_PLAN_IDS.includes(p.id))
...
export const EN_GUIDE: EnSectionsContent = {
  ...
  metaDescription: "Where to see sea turtles in Miyakojima, the best season and beaches, plus safety tips. Family-friendly private snorkel tours by Sea Turtle Brothers.",
...
export const EN_PRIVACY: EnSectionsContent = {
  ...
  sections: [
    { heading: "1. Information We Collect", paragraphs: ["We collect booking information and, with your consent, linked browsing information."], bullets: ["The lead guest's name, phone number, and email address", "Your LINE user ID and display name (if you connect with us via LINE)", "Each participant's name, age, height and weight (optional), and shoe size", "Any requests or questions you enter in our forms", "Pages viewed, referral source, clicks, scrolling, form activity, and booking outcome", "Visitor ID, Visit ID, booking funnel ID, and device, browser, and operating-system categories"] },
    { heading: "2. How We Use Your Information", paragraphs: ["We use the information we collect for the following purposes."], bullets: ["Receiving, confirming, changing, or canceling your booking, and contacting you about it", "Managing safety and preparing equipment (fins, wetsuits, and so on)", "Delivering the photos and videos taken during your tour", "Responding to your inquiries", "Linking consented pre-booking browsing history with booking information to improve services and analyze marketing and booking journeys"] },
    ...
    { heading: "4. Third-Party Services We Use", paragraphs: ["We use the following external services to operate our business, and information is stored with these services to the extent necessary."], bullets: ["Booking and linked customer analytics: Google Sheets (Google LLC)", "Guest communication: LINE (LY Corporation)", "Website usage analytics: Vercel Analytics", "Website usage analytics: Google Analytics (Google LLC), loaded after consent and using cookies or similar identifiers. See Google's Policies and Terms for details."] },
...
export const EN_FORM: IntlFormCopy = {
  ...
  rentalHeading: "Rental options",
  wetsuitRentalLabel: "Wetsuit rental",
  prescriptionMaskRentalLabel: "Prescription mask rental",
  rentalIncludedLabel: "included in tour price",
