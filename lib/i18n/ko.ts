...
const KO_HOME = {
  ...
  metaDescription: "미야코지마의 프라이빗 투어와 1일 1팀 한정 선셋 SUP. 사진·영상 무료, 전날까지 취소 무료. Sea Turtle Brothers.",
  hero: {
    badge: "미야코지마 가족 친화 마린 투어",
    title: "미야코지마에서 바다거북과 헤엄치다",
    subtitle: "초보자와 가족을 위해 설계된 프라이빗 투어와 1일 1팀 한정 선셋 SUP — 사진·영상 무료, 투어 전날까지 취소 무료.",
  },
  trustItems: [
    "프라이빗 투어, 보험 완비",
    "수중 사진·영상 무료",
  ...
  toursHeading: "투어 소개",
  toursIntro: "프라이빗 바다거북 스노클링, 프라이빗 정글 나이트 투어, 프라이빗 드론 SUP, 그리고 1일 1팀 한정 선셋 SUP — 미야코지마의 바다와 자연을 즐기는 4가지 체험.",
  faqHeading: "자주 묻는 질문",
...
const KO_COMMON: IntlCommonCopy = {
  ...
  plansIntro: "프라이빗 바다거북 스노클링, 프라이빗 정글 나이트 투어, 프라이빗 드론 SUP, 1일 1팀 한정 선셋 SUP. 모든 투어에 사진·영상이 무료로 포함되며 투어 전날까지 취소 무료입니다.",
