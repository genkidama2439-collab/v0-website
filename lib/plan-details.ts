...
export const PLAN_DETAILS: Record<string, PlanDetail> = {
  ...
  S3: {
    ...
    flow: [
      { step: 1, title: "集合・受付", description: "開催場所にて現地集合。ガイドがお出迎えし、注意事項や生き物を探すコツを説明します。", time: "19:20 / 21:10 / 23:20" },
    ...
    meetingTime: "開始時間と同じ（19:20 / 21:10 / 23:20）",
    paymentMethod: "現地現金決済（できるだけお釣りが出ないようご協力ください）",
    faqs: [
  ...
  S4: {
    ...
    flow: [
      ...
      { step: 3, title: "海上SUP＆夕日鑑賞＆ドローン撮影", description: "海へ出発！夕日を浴びながらのんびり海上散歩。絶景をバックに手持ち撮影とドローン空撮を行います。", time: "約2時間" },
      { step: 4, title: "お会計・解散", description: "マジックアワーの余韻に浸りながらお会計。撮影データは当日中にお渡し。", time: "日没の約30分後" },
    ],
    included: ["SUPボード", "パドル", "ライフジャケット", "ウェットスーツ", "度付きマスク（大人用のみ）", "ドローン撮影", "写真・動画データ（枚数無制限）", "保険", "陸上レクチャー", "専属ガイド"],
    whatToBring: ["着替え", "タオル", "日焼け止め", "飲み物", "サンダル"],
    precautions: ["妊娠中の方は参加不可", "持病をお持ちの方は参加不可", "飲酒されている方は参加不可", "お体に不自由がある場合は必ず事前にご相談ください", "強風・雨・飛行制限・安全判断によりドローン撮影ができない場合があります。その場合も海上からの写真撮影は行います"],
  ...
  S8: {
    ...
    whatToBring: ["着替え", "タオル", "日焼け止め", "飲み物", "サンダル"],
    precautions: ["妊娠中の方は参加不可", "持病をお持ちの方は参加不可", "飲酒されている方は参加不可", "お体に不自由がある場合は必ず事前にご相談ください", "他のお客様との相乗りツアーです。貸切をご希望の場合は【貸切】サンセットSUPをご予約ください", "強風・雨・飛行制限・安全判断によりドローン撮影ができない場合があります。その場合も海上からの写真撮影は行います"],
    location: "トゥリバー海浜公園／パシャビーチ／与那覇ビーチ北／インギャーマリンガーデン／西浜ビーチ のいずれか",
    locationNote: "上記5か所から当日の風向き・海況がベストな場所を選び、前日にLINEで地図付きでご案内します。各候補地の地図は「集合場所・アクセス」ページをご覧ください。",
    meetingTime: "日没の約90分前（8月は17:45頃・12月は16:30頃。正確な時間は前日にLINEで確定）",
    paymentMethod: "現地現金決済（できるだけお釣りが出ないようご協力ください）",
  ...
  S7: {
    ...
    included: ["SUPボード", "パドル", "ライフジャケット", "ウェットスーツ", "度付きマスク（大人用のみ）", "ドローン撮影", "写真・動画データ", "保険", "陸上レクチャー", "専属ガイド"],
    whatToBring: ["着替え", "タオル", "日焼け止め", "飲み物", "サンダル"],
    precautions: [
      "妊娠中の方は参加不可",
      "持病をお持ちの方は参加不可",
  ...
  S5: {
    ...
    flow: [
      { step: 1, title: "集合・受付", description: "開催場所にて現地集合。専属ガイドがお出迎えし、注意事項や生き物を探すコツを説明します。", time: "19:20 / 21:10 / 23:20" },
  ...
  C1: {
    ...
    flow: [
      ...
      { step: 3, title: "【夜】集合・受付", description: "夜は開催場所に再集合。懐中電灯などをお貸出しし、生き物を探すコツを説明します。", time: "19:20 / 21:10 / 23:20 から選択" },
    ...
    meetingTime: "ウミガメツアー開始の15分前 ／ ヤシガニ探検は 19:20 / 21:10 / 23:20",
    paymentMethod: "現地現金決済（できるだけお釣りが出ないようご協力ください）",
    faqs: [
      { q: "海亀ツアーとヤシガニ探検は同じ日に行いますか？", a: "はい。昼にウミガメシュノーケル、夜にヤシガニ探検を同日に体験いただくセットプランです。海亀ツアーの時間（9:00 / 11:00 / 14:00 / 16:00）とヤシガニ探検の時間（19:20 / 21:10 / 23:20）を、それぞれご予約時にお選びください。" },
  ...
  C2: {
    ...
    flow: [
      ...
      { step: 3, title: "【夜】集合・受付", description: "夜は開催場所に再集合。専属ガイドが生き物の探し方や注意点を案内します。", time: "19:20 / 21:10 / 23:20 から選択" },
  ...
  C4: {
    ...
    included: ["シュノーケル器材一式", "ライフジャケット", "浮き輪", "SUPボード一式", "ウェットスーツ", "度付きマスク（大人用のみ）", "写真・動画データ（枚数無制限）", "ドローン撮影データ", "保険", "安全講習", "専属ガイド"],
    whatToBring: ["着替え", "タオル", "日焼け止め", "飲み物", "サンダル（推奨）"],
    precautions: [
  ...
  C5: {
    ...
    flow: [
      ...
      { step: 5, title: "【夜】ナイトツアー集合・探検", description: "夜は開催場所に再集合。懐中電灯を持って夜の亜熱帯を探検し、巨大ヤシガニや夜行性の生き物を探します。終了後にお会計・解散。", time: "19:20 / 21:10 / 23:20 から選択・約1.5時間" },
    ],
    ...
    meetingTime: "ウミガメツアー開始の15分前 ／ ナイトツアーは 19:20 / 21:10 / 23:20",
    paymentMethod: "現地現金決済（できるだけお釣りが出ないようご協力ください）",
    faqs: [
      { q: "3つのツアーは同じ日に行いますか？", a: "はい。朝にウミガメシュノーケル、昼にドローンSUP、夜にナイトツアーを同日に体験いただく1日セットプランです。シュノーケルの時間とナイトツアーの時間（19:20 / 21:10 / 23:20）をご予約時にお選びください。ドローンSUPはシュノーケルから続けて開催します。" },
  ...
  C6: {
    ...
    flow: [
      ...
      { step: 4, title: "【夕方】一旦解散・自由時間", description: "夜のナイトツアーまでは自由時間。夕食や休憩をお取りください。" },
      { step: 5, title: "【夜】貸切ナイトツアー集合・探検", description: "夜は開催場所に再集合。専属ガイドと夜の亜熱帯を探検し、巨大ヤシガニや夜行性の生き物を探します。終了後にお会計・解散。", time: "19:20 / 21:10 / 23:20 から選択・約1.5時間" },
    ],
