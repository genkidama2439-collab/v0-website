...
export const PLAN_DETAILS: Record<string, PlanDetail> = {
  ...
  S4: {
    id: "S4",
    name: "【貸切】サンセットSUP",
    tagline: "1組貸切だけの特別な夕日。黄金に染まる海で極上のひとときを。",
    heroDescription: "1組貸切だから叶う、完全プライベートのサンセット体験。他のお客様を気にせず、海の上から眺める夕日のグラデーションを独り占め。初心者でも安定のボードで安心。エモーショナルなシルエット写真が大人気！",
    ...
    included: ["SUPボード", "パドル", "ライフジャケット", "ウェットスーツ", "度付きマスク（大人用のみ）", "写真・動画データ（枚数無制限）", "保険", "陸上レクチャー", "専属ガイド"],
  ...
  S8: {
    id: "S8",
    name: "サンセットSUP",
    tagline: "黄金に染まる海へ。夕日を浴びながらの海上散歩。",
    heroDescription: "宮古島の夕日を海の上から楽しむSUP体験。少人数の相乗りツアーなので、貸切より気軽にご参加いただけます。初心者でも安定のボードで安心。エモーショナルなシルエット写真が大人気！",
    image: PLAN_COVER_IMAGE.sup,
    images: TOUR_IMAGE_PATHS.sup,
    color: "orange",
    gradientFrom: "from-orange-500",
    ...
    whatToBring: ["着替え", "タオル", "日焼け止め", "飲み物", "サンダル"],
    precautions: ["妊娠中の方は参加不可", "持病をお持ちの方は参加不可", "飲酒されている方は参加不可", "お体に不自由がある場合は必ず事前にご相談ください", "他のお客様との相乗りツアーです。貸切をご希望の場合は【貸切】サンセットSUPをご予約ください"],
    location: "トゥリバー海浜公園／パシャビーチ／与那覇ビーチ北／インギャーマリンガーデン／西浜ビーチ のいずれか",
    locationNote: "上記5か所から当日の風向き・海況がベストな場所を選び、前日にLINEで地図付きでご案内します。各候補地の地図は「集合場所・アクセス」ページをご覧ください。",
    meetingTime: "日没の約90分前（8月は17:45頃・12月は16:30頃。正確な時間は前日にLINEで確定）",
    paymentMethod: "現地現金決済（できるだけお釣りが出ないようご協力ください）",
